...
| Archetype | Key Themes | What They Buy |
|-----------|------------|---------------|
...
| If the role is... | Emphasize about the candidate... | Sources of proof points |
|-------------------|--------------------------|--------------------------|
...
Use WebSearch for current salaries (Glassdoor, Levels.fyi, Blind), company's comp reputation, demand trend. Table with data and cited sources. If no data, say so.
...
Top 5 changes to CV + Top 5 changes to LinkedIn.
