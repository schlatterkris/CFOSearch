...
| `angebot.md` | `modes/evaluate.md` (EN) | Vollständige Bewertung einer einzelnen Stellenanzeige (Blöcke A-F) |
...
Die übrigen Modi (`scan`, `batch`, `pdf`, `tracker`, `auto-pipeline`, `deep`, `contact`, `compare`, `project`, `training`) sind absichtlich nicht in diesem PR dabei. Sie funktionieren weiter über die EN-Originale, weil ihr Inhalt zu großen Teilen aus Tooling, Pfaden und Konfigurationskommandos besteht — diese sollen sprachunabhängig bleiben.
